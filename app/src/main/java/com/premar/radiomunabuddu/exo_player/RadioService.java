...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener{
    ...
    public static final String ACTION_PLAY = "com.premar.radiomunabuddu.exo_player.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.premar.radiomunabuddu.exo_player.ACTION_PAUSE";
    public static final String ACTION_STOP = "com.premar.radiomunabuddu.exo_player.ACTION_STOP";
